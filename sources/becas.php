...
$query =  "SELECT * FROM beca_curso WHERE id=".$id;
...
$query  =  "SELECT  * FROM beca_curso WHERE nombre=:nombre";
...
$query  =  "INSERT INTO  beca_curso(nombre,estado)
