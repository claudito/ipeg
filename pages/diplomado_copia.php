...
acciones += '<button type="button" class="btn btn-secondary btn-primary"><i class="fa fa-edit"></i> Plantilla Correo Presencial</button>';
acciones += '<button type="button" class="btn btn-default"><i class="fa fa-edit"></i>   Plantilla Correo Virtual</button>';
acciones += '<button type="button" class="btn btn-secondary"><i class="fa fa-edit"></i> Brochure Presencial</button>';
acciones += '<button type="button" class="btn btn-default"><i class="fa fa-edit"></i> Brochure Virtual</button>';
acciones += '</div>';
