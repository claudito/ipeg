...
$session->acceso();
$assets =  new Assets();
$assets->nav('..','Promociones');
$assets->breadcrumbs('Reserva','Promociones')
 ?>
...
"bProcessing": true,
"sAjaxSource": "../sources/promociones.php?op=1",
"aoColumns": [
...
url = "../sources/promociones.php?op=2";
...
url:"../sources/promociones.php?op=3",
type:"POST",
dataType :"JSON",
data:parametros,
beforeSend:function()
