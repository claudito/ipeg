...
$session->acceso();
$assets =  new Assets();
$assets->nav('..','Modalidad');
$assets->breadcrumbs('Reserva','Modalidad');
 ?>
...
<div class="modal fade" id="modal-registro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
    <label>Nombre</label>
    <input type="text" name="nombre" class="nombre form-control" placeholder="Ingrese el nombre" 
     onchange="Mayusculas(this)" required="">
    </div>

    <div class="form-group">
    <label>Semana</label>
    <input type="number" min="1" max="52" name="semana" class="semana form-control" placeholder="Ingrese el Número de Semanas" 
      required="">
    </div>

    <div class="form-group">
    <label>Costo</label>
    <input type="number" step="any" min="0.00" max="9999"   name="costo" class="costo form-control" placeholder="Ingrese el Costo"  required="">
    </div>
...
"bProcessing": true,
"sAjaxSource": "../sources/modalidad.php?op=1",
"aoColumns": [
...
url = "../sources/modalidad.php?op=2";
...
url:"../sources/modalidad.php?op=3",
type:"POST",
dataType :"JSON",
data:parametros,
beforeSend:function()
