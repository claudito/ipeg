...
$assets =  new Assets();
$assets->nav('..','Becas');
$assets->breadcrumbs('Reserva','Becas')
 ?>
...
<div class="modal fade" id="modal-registro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
    <label>Nombre</label>
     <textarea name="nombre" class="nombre form-control" placeholder="Ingrese la descripción de la beca." 
...
"bProcessing": true,
"sAjaxSource": "../sources/becas.php?op=1",
"aoColumns": [
