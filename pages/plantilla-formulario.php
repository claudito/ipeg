...
$session->acceso();
$assets =  new Assets();
$assets->nav('..','Plantilla Formulario');
$assets->breadcrumbs('Reserva','Plantilla Formulario');
$assets->summernote();
 ?>
...
"bProcessing": true,
"sAjaxSource": "../sources/plantilla-formulario.php?op=1",
"aoColumns": [
...
url = "../sources/plantilla-formulario.php?op=2";
...
url:"../sources/plantilla-formulario.php?op=3",
type:"POST",
data:parametros,
beforeSend:function()
{
